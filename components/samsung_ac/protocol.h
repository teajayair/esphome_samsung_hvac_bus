...
namespace esphome
{
    namespace samsung_ac
    {
        ...
        public:
            ...
            virtual void set_flow_sensor(const std::string& address, float value) = 0;
            virtual void set_tw1_sensor(const std::string& address, float value) = 0;
            virtual void set_tw2_sensor(const std::string& address, float value) = 0;
        };
